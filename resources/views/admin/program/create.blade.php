            ...
            <div class="card-body">
                ...
                <form action="{{ route('program.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_program" id="nama_program" required="" placeholder="Masukkan Nama Program" minlength="5" maxlength="191">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="harga" id="harga" required="" placeholder="Masukkan Harga Program" maxlength="20">
                    </div>

                    <div class="form-group">
                        <label for="diskon">Diskon</label>
                        <input type="number" class="form-control" name="diskon" id="diskon" placeholder="0%" maxlength="20">
                        <code class="highlighter-rouge">*Boleh Kosong</code>
                    </div>

                    <div class="form-group">
                        <label for="total_waktu">Total Waktu Pembelajaran</label>
                        <input type="text" class="form-control" name="total_waktu" id="total_waktu" placeholder="Masukkan Total Waktu Pembelajaran" maxlength="20">
                        <code class="highlighter-rouge">*Boleh Kosong</code>
                    </div>
