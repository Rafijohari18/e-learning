        ...
        <div class="row">
        	<div class="col-lg-6">
                ...
                <form method="GET" action="" class="row">
                    ...
                    <div class="form-group col-md-6">
                       <textarea name="alamat" id="alamat" cols="30" rows="4" class="form-control" placeholder="Alamat" required="">{{ old('alamat') }}</textarea>
                    </div>
                    ...
                    <div class="table-responsive order_table">
                        <table class="table">
                            ...
                            <tfoot>
                                <tr>
                                    <th>SubTotal</th>
                                    <td class="product-subtotal">Rp. 0</td>
                                </tr>
                                <tr>
                                    <th>Diskon</th>
                                    <td>-</td>
                    ...
                    <div class="payment_method">
                        ...
                        <div class="payment_option">
                            <div class="custome-radio">
                                <input class="form-check-input" required="" name="payment" type="radio" id="kartuprakerja" value="kartuprakerja" checked="">
